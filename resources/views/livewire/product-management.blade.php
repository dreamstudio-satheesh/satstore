        ...
        <div class="col-lg-8 col-md-8 col-sm-12">
            <div class="card">
                <div class="card-header">
                    <h5>Products</h5>
                    <input id="searchInput" wire:model.live.300ms="search" type="text" class="form-control"
                ...
                <div class="card-body">
                    <form wire:submit.prevent="store">
                        <div class="form-group">
                            <input type="text" class="form-control" wire:model="name_tamil"
                                placeholder="Name (Tamil)" autofocus>
                            @error('name_tamil')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-control" wire:model="name_english"
                        ...
                        <div class="pt-3">
                            <button type="submit" class="btn btn-rounded btn-secondary" wire:loading.attr="disabled">
                                Save <span wire:loading wire:target="store"
